package com.monopoly.game.board;
...
import com.monopoly.game.tax.Tax;
import com.monopoly.game.util.Railroad;
import com.monopoly.game.util.Square;
import com.monopoly.game.util.Utility;
...
public class Board {
    ...
    public Board(Jail jail, Dice dice, List<Player> players){
        this.jail = jail;
        this.dice = dice;
